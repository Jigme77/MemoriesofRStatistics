...
Where I will show to effectively learn. .
...
So hello- I'm so happy to meet you guys and give this talk on learning. 
...
[`r icons::fontawesome("github")` @jigme77](https://github.com/apreshill)  
[`r icons::fontawesome("twitter")` @tenz_jigme](https://twitter.com/apreshill)  
...
???
I feel it is prerequisite for everyone to love learning. Because what is life we do not give time to learn and relearn things. 
I try learning new things. I can programme a bit in R. I read nonfiction books. And now, in my free time, I am learning korean.
...
[`r icons::fontawesome("twitter")` @apreshill](http://twitter.com/apreshill)  
[`r icons::fontawesome("github")` @apreshill](http://github.com/apreshill)  
[`r icons::fontawesome("link")` alison.rbind.io](https://alison.rbind.io)  
[`r icons::fontawesome("paper-plane")` alison@rstudio.com](mailto:alison@rstudio.com)
