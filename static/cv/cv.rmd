...
CV <- create_CV_object(
  data_location = "https://docs.google.com/spreadsheets/d/1_zXYDbDmgBj3pp2Ez53CjCMtUq8bLO6pvwxxdnRRNTY/edit#gid=917338460",  
...
```{r}
#if(params$pdf_mode){
 # cat("View this CV online with links at jigme-tenzin.netlify.app/cv")
#} else {
 # cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/jigme77/cv/raw/master/jigme_cv.pdf)")
#}
```
